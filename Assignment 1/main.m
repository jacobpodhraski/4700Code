...
%                        if((init(j,2) + init(j,1)*timestep)>= ybox2 &&(init(j,2) + init(j,1)*timestep)>= xbox1 && (init(j,2) + init(j,1)*timestep)<= xbox2)
%                             init(j,4) = -init(j,4);
%                             init(j,3) = pi - init(j,3);
%                        elseif ((init(j,2) + init(j,1)*timestep)<= ybox1 &&(init(j,2) + init(j,1)*timestep)>= xbox1 && (init(j,2) + init(j,1)*timestep)<= xbox2)
%                             init(j,4) = -init(j,4);
%                             init(j,3) = pi - init(j,3);
